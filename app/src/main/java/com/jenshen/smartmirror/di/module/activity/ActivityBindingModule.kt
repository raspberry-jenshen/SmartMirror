...
abstract class ActivityBindingModule {
    ...
    @Binds
    @IntoMap
    @ActivityKey(ChooseAccountActivity::class)
    abstract fun chooseAccountActivityComponentBuilder(impl: ChooseAccountComponent.Builder): ActivityComponentBuilder<*>
}