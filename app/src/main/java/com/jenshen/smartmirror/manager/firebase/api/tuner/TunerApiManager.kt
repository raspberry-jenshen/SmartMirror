...
interface TunerApiManager {
    ...
    fun addWidget(widget: Widget): Completable

    /* mirror configurations */
    fun addWidgetInConfiguration(mirrorConfiguration: MirrorConfiguration): Completable

    fun addMirrorConfiguration(mirrorConfiguration: MirrorConfiguration): Single<String>

    fun editMirrorConfiguration(mirrorId: String, mirrorConfiguration: MirrorConfiguration): Completable
